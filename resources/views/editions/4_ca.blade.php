<section aria-labelledby="about-1" class="about-block" aria-live="polite">
  ...
  <p>
      Ja vam començar <a href="{{ url('/archive/2017') }}">fa cinc anys</a> amb aquest format de
  ...
  <div id="about-1-more" class="about-block__01-hidden">
      <p>
          ...
          setembre de 2021, s'obrirà un termini de tres setmanes per tal que els
...
<section id="calendar" aria-labelledby="about-2" class="about-block about-block--calendar">
  ...
  <h3 id="about-2-cal">Calendari</h3>
          ...
          <div class="phase__calendar">
              <div class="calendar">
                  ...
                  <div class="calendar__dates">
                      ...
                      <div class="calendar__month">set / oct</div>
                  </div>
              </div>
          </div>
...
<section id="kit" aria-labelledby="about-6" class="about-block">
  ...
  <p>Des de Participació farem campanya perquè la gent d'Altea conega les propostes i vote la que més li agrade, però us animem que participeu i que creeu la vostra pròpia campanya. Sabem que no és fàcil, però us deixem ací un PDF que podeu descarregar amb tota la informació perquè construïu la campanya per a la vostra proposta.</p>
   <p class="mb-0">
      <a href="/docs/KitParticipa_VAL.pdf" class="about-block__read-more-link" role="button" aria-expanded="false" aria-controls="about-1-more" aria-labelledby="about-1">
          <i class="far fa-arrow-circle-down fa-fw"></i> Descarrega el Kit Participa
      </a>
  </p>
</section>
...
<section id="archive" aria-labelledby="about-5" class="about-block about-block--last">
  ...
  <div>
      <h4 class="mb-4">Resultats de 2020</h4>
      <div class="row results results-2017 results-2017--compact mt-3">
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card results__card--winner">
                  <span class="results__card__number d-none d-md-inline" style="top: -2rem">1</span>
                  <h5><span>Enllumenat del Camí Fondo</span> <i class="far fa-check" aria-hidden="true"></i></h5>
                  <div class="results__votes">
                      <div class="results__points">441 vots</div>
                      <div class="progress">
                          <div class="d-flex" style="width: 18%" aria-valuenow="17" aria-valuemin="0" aria-valuemax="100" role="progressbar">
          ...
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card">
                  <span class="results__card__number d-none d-md-inline" style="top: -2rem">2</span>
                  <h5>Pump Track</h5>
                  <div class="results__votes">
                      <div class="results__points">419 vots</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card">
                  <span class="results__card__number d-none d-md-inline" style="top: -2rem">3</span>
                  <h5>Millora dels Parcs Infantils</h5>
                  <div class="results__votes">
                      <div class="results__points">414 vots</div>
                      <div class="progress">
                          <div class="d-flex" style="width: 11%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" role="progressbar">
                              <div class="progress-bar"></div>
                          </div>
                      </div>
                  </div>
          ...
          <div class="d-flex justify-content-center col-md-6 results-2017__execution">
              <div class="results-2017__execution__block">
                  <ol start="4" class="results-2017__descending-list">
                      <li>Trituradora de compostatge (264 vots)</li>
                      <li>Millores esportives a Altea la Vella (255 vots)</li>
                      <li>Condicionament del carrer Costa Blanca i Passatge Llaurador (238 vots)</li>
                  </ol>
                  <hr class="my-3" aria-hidden="true" />
                  <a href="{{ url('/archive/3') }}">
                      <i class="far fa-chart-bar" aria-hidden="true"></i> Resultats complets 2020
                  </a>
              </div>
          </div>
      </div>
                  ...
                  <div class="phase">
                      <div class="phase__calendar">
                          <div class="calendar">
                              <div class="calendar__heading">Propostes</div>
                              <div class="calendar__dates">
                                  <div class="calendar__days"><strong>fins el 24</strong></div>
