<section aria-labelledby="about-1" class="about-block" aria-live="polite">
  ...
  <p>
      It started <a href="{{ url('/archive/2017') }}">eight years ago</a> with this format
  ...
  <div id="about-1-more" class="about-block__01-hidden">
      <p>
          ...
          that make it to the ballot will be chosen from among citizen submissions. On October 2025,
...
<section id="propose" aria-labelledby="propose-h" class="about-block about-block--propose">
    <h3 id="propose-h">Submit your proposal</h3>
...
<section id="info" aria-labelledby="about-4" class="about-block about-block--info">
  ...
  <div class="columns">
      ...
      <p>
          On-line voting will open on December 1st at midnight and will
          close on December 12th at 23:59.
      </p>
      ...
      <div class="row results results-2017 results-2017--compact mt-3">
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card results__card--winner">
                  ...
                  <div class="results__votes">
                      <div class="results__points">170 votes</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card">
                  ...
                  <div class="results__votes">
                      <div class="results__points">151 votes</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card">
                  ...
                  <div class="results__votes">
                      <div class="results__points">132 votes</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-6 results-2017__execution">
              <div class="results-2017__execution__block">
                  <ol start="4" class="results-2017__descending-list">
                      <li>Millora de parcs infantils (128 votes)</li>
                      <li>Aparcament Altea la Vella (106 votes)</li>
                      <li>Retenció de plàstics generats al carrer (104 votes)</li>
                  </ol>
                  <hr class="my-3" aria-hidden="true" />
                  <a href="{{ url('/archive/4') }}">
                      <i class="far fa-chart-bar" aria-hidden="true"></i> Full 2022 results
                  </a>
              </div>
          </div>
      </div>
