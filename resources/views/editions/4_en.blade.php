<section aria-labelledby="about-1" class="about-block" aria-live="polite">
  ...
  <p>
      It started <a href="{{ url('/archive/2017') }}">five years ago</a> with this format
  ...
  <div id="about-1-more" class="about-block__01-hidden">
      <p>
          ...
          that make it to the ballot will be chosen from among citizen submissions. On September 2021,
      ...
      <div class="row results results-2017 results-2017--compact mt-3">
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card results__card--winner">
                  ...
                  <h5><span>Enllumenat del Camí Fondo</span> <i class="far fa-check" aria-hidden="true"></i></h5>
                  <div class="results__votes">
                      <div class="results__points">441 votes</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card">
                  ...
                  <h5>Pump Track</h5>
                  <div class="results__votes">
                      <div class="results__points">419 votes</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card">
                  ...
                  <h5>Millora dels Parcs Infantils</h5>
                  <div class="results__votes">
                      <div class="results__points">414 votes</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-6 results-2017__execution">
              <div class="results-2017__execution__block">
                  <ol start="4" class="results-2017__descending-list">
                      <li>Trituradora de compostatge (265 votes)</li>
                      <li>Millores esportives a Altea la Vella (255 votes)</li>
                      <li>Condicionament del carrer Costa Blanca i Passatge Llaurador (238 votes)</li>
                  </ol>
                  <hr class="my-3" aria-hidden="true" />
                  <a href="{{ url('/archive/1') }}">
                      <i class="far fa-chart-bar" aria-hidden="true"></i> Full 2020 results
                  </a>
              </div>
          </div>
      </div>
