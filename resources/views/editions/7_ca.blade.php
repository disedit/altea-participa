<section aria-labelledby="about-1" class="about-block" aria-live="polite">
  ...
  <p>
      Ja vam començar <a href="{{ url('/archive/2017') }}">fa huit anys</a> amb aquest format de
  ...
  <div id="about-1-more" class="about-block__01-hidden">
      <p>
          ...
          sotmeten a votació hagen estat proposats per la ciutadania. Al mes d'octubre de 2025, s'obrirà un termini de tres setmanes per tal que els
...
<section id="info" aria-labelledby="about-4" class="about-block about-block--info">
  ...
  <div class="columns">
      ...
      <p>
        ...
        12h de la nit del dia 1 de desembre i conclourà el dia 12
        a les 23:59.
      </p>
...
<section id="archive" aria-labelledby="about-5" class="about-block about-block--last">
  ...
  <div>
      <h4 class="mb-4">Resultats de 2022</h4>
      <div class="row results results-2017 results-2017--compact mt-3">
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card results__card--winner">
                  ...
                  <div class="results__votes">
                      <div class="results__points">170 vots</div>
                      <div class="progress">
                          <div class="d-flex" style="width: 18%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" role="progressbar">
          ...
          <div class="d-flex justify-content-center col-md-6 results-2017__execution">
              <div class="results-2017__execution__block">
                  ...
                  En procés d'adjudicació licitació
          ...
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card">
                  ...
                  <div class="results__votes">
                      <div class="results__points">151 vots</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-4">
              <div class="results__card">
                  ...
                  <div class="results__votes">
                      <div class="results__points">132 vots</div>
                      <div class="progress">
          ...
          <div class="d-flex justify-content-center col-md-6 results-2017__execution">
              <div class="results-2017__execution__block">
                  <ol start="4" class="results-2017__descending-list">
                      <li>Millora de parcs infantils (128 vots)</li>
                      <li>Aparcament Altea la Vella (106 vots)</li>
                      <li>Retenció de plàstics generats al carrer (104 vots)</li>
                  </ol>
                  <hr class="my-3" aria-hidden="true" />
                  <a href="{{ url('/archive/4') }}">
                      <i class="far fa-chart-bar" aria-hidden="true"></i> Resultats complets 2022
                  </a>
              </div>
          </div>
      </div>
                  ...
                  <div class="phase">
                      <div class="phase__calendar">
                          <div class="calendar">
                              <div class="calendar__heading">Propostes</div>
                              <div class="calendar__dates">
                                  <div class="calendar__days"><strong>fins el 10</strong></div>
